...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(beaver1, }\DataTypeTok{n =} \DecValTok{5}\NormalTok{)}
\CommentTok{#>   day time  temp activ}
\CommentTok{#> 1 346  840 36.33     0}
\CommentTok{#> 2 346  850 36.34     0}
\CommentTok{#> 3 346  900 36.35     0}
\CommentTok{#> 4 346  910 36.42     0}
\CommentTok{#> 5 346  920 36.55     0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{?bookdown}\OperatorTok{::}\NormalTok{bs4_book}
\end{Highlighting}
\end{Shaded}
